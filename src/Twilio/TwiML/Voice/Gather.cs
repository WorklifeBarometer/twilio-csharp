...
namespace Twilio.TwiML.Voice 
{
    ...
    public class Gather : TwiML 
    {
        ...
        protected override List<XAttribute> GetElementAttributes()
        {
            ...
            {
                attributes.Add(new XAttribute("profanityFilter", this.ProfanityFilter.Value.ToString()));
            }
            ...
            {
                attributes.Add(new XAttribute("partialResultCallback", this.PartialResultCallback.AbsoluteUri));
            }
            ...
            {
                attributes.Add(new XAttribute("bargeIn", this.BargeIn.Value.ToString()));
            }
            return attributes;
        }
        ...
        public Gather Say(string message = null, Say.VoiceEnum voice = null, int? loop = null, Say.LanguageEnum language = null)
        {
