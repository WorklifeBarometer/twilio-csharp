...
namespace Twilio.TwiML.Voice 
{
    ...
    public class Record : TwiML 
    {
        ...
        protected override List<XAttribute> GetElementAttributes()
        {
            ...
            {
                attributes.Add(new XAttribute("playBeep", this.PlayBeep.Value.ToString()));
            }
            if (this.Trim != null)
            {
            ...
            {
                attributes.Add(new XAttribute("transcribe", this.Transcribe.Value.ToString()));
            }
            if (this.TranscribeCallback != null)
            {
                attributes.Add(new XAttribute("transcribeCallback", this.TranscribeCallback.AbsoluteUri));
            }
            return attributes;
        }
    }
